...
//    {
//        private readonly string username = "group1"; private readonly string password = "inc.382"; private readonly ILogger<PIController> _logger;
...
//                HttpClientHandler clientHandler = new HttpClientHandler { Credentials = credentrials }; clientHandler.ServerCertificateCustomValidationCallback = (sender, cert, chain, sslPolicyErrors) => { return true; }; // acess to https HttpClient client = new HttpClient(clientHandler);
//                string webId = "";
...
//                {
//                    string content = await response.Content.ReadAsStringAsync();
//                    var data = (JArray)JObject.Parse(content)["Items"]; var result = new List<TagValue>();
