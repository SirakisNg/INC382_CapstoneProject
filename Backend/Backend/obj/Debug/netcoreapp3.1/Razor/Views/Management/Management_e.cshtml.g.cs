#pragma checksum "/Users/sirakis/Documents/GitHub/INC382_CapstoneProject/Backend/Backend/Views/Management/Management_e.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "008a29a31633725c445410ce6ddaa2c6a2438618"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Management_Management_e), @"mvc.1.0.view", @"/Views/Management/Management_e.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"008a29a31633725c445410ce6ddaa2c6a2438618", @"/Views/Management/Management_e.cshtml")]
    ...
    #nullable restore
    public class Views_Management_Management_e : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
...
<script>
  await fetch('https://localhost:7000/api/pi?itemname=A002-0000-S2-DATA10')
    .then(response => response.json())
    .then(data => data.result[0].values)
    .then(data1 => sw1 = data.result[1].values)
    .then(data2 => sw2 = data.result[2].values)
    .then(data3 => sw3 = data.result[3].values)
    .then(data4 => sw4 = data.result[4].values)
    .then(data5 => sw5 = data.result[5].values)
    .then(data6 => sw6 = data.result[6].values)
    .then(data7 => sw7 = data.result[7].values)
</script>

");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "008a29a31633725c445410ce6ddaa2c6a24386184233", async() => {
                WriteLiteral(@"
  <meta charset=""utf-8"">
  ...
  <script type=""text/javascript"">
    ...
    function drawFilledChart() {
      ...
      var options = {
        ...
        pieSliceText: 'value-");
                WriteLiteral(@"and-percentage',          //show both of value and percentage in pie chart
    ...
    function drawTruckInOutChart() {
      ...
      var chart = new google.visualization.ColumnChart(document.getEleme");
                WriteLiteral(@"ntById(""TruckInOut""));
    ...
    function drawWaitingTime() {
      var data = google.visualization.arrayToDataTable([
        ...
        [""Inbound WB"", 8.22, ""#96CFCF""],
        [""DIESEL Bay"", 8.51, ""#FF8F7F""],
        [""GASOHOL95 Bay"", 1.00, ""#FEB9D0""],
        [""Outbound WB"", 3.14, ""#C1B2C6""],
      ]);
    ...
    function drawUtilization() {
      var data = google.visualization.arrayToDataTable([
        ...
        [""Sale Officer"", 25.57, ""#AFD7F6""],
        [""Inbound WB"", 37.73, ""#96CFCF""],
        [""DIESEL Dispenser"", 31.19, ""#FF8F7F""],
        [""GASOHOL95 Dispenser"", 16.91, ""#FEB9D0""],
        [""Outbound WB"", 32.68, ""#C1B2C6""],
      ]);
    ...
    function drawFailedTime() {
      var data = google.visualization.arrayToDataTable([
        ["" Name"", ""number"", { role: ""style"" }],
        [""GASOHOL95 BAY"", 9, ""FF9900""],
        [""DIESEL BAY"", 25, ""65CCCC""],
      ]);
...
");
            ...
            WriteLiteral("\n\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "008a29a31633725c445410ce6ddaa2c6a243861815236", async() => {
                WriteLiteral(@"
  <div class=""wrapper"">
